                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                                    ...
                                    <input id="nama" name="nama"  value="{{ $data->nama }}" required type="text" class="form-control" data-mask placeholder="Masukkan Nama">
                                    @if ($errors->has('nama'))
                                ...
                                <div class="form-group{{ $errors->has('nim') ? ' has-error' : '' }}">
                                    ...
                                    <input id="nim" name="nim"  value="{{ $data->nim }}" required type="text" class="form-control" data-mask disabled placeholder="NIM">
                                    @if ($errors->has('nim'))
                                    <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('tempat_lahir') ? ' has-error' : '' }}">
                                    ...
                                    <input id="tempat_lahir" name="tempat_lahir"  value="{{ $data->tempat_lahir }}" required type="text" class="form-control" data-mask placeholder="Masukkan Kota Lahir">
                                ...
                                <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="prodi" required="">
                                        ...
                                        <option value="SI" {{$data->prodi === "MI" ? "selected" : ""}} >Manajemen Informatika</option>
                                    </select>
                                    </div>
                                </div>
